...
d3.select("#filter-btn").on("click", runfilteredData);
...

{
 ...
 /////////////////////////////////////////////
    ...
    let asArray = Object.entries(filteredData);
    let filtered = asArray.filter(row => row.datetime === inputdateValue); 
...
////////////////////////////////////////////////
  ...
  var filterBYDATE = filteredData.filter(data1 => filteredData.datetime === inputdateValue);
